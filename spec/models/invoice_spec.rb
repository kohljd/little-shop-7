      ...
      describe "it calculates an invoice's total discounted revenue" do
        describe "scenarios:" do
          ...
          it "no qualifying bulk discount" do
            ...
            expect(invoice_1.total_discounted_revenue(invoice_1, merchant_1)).to eq(20000)
          end
          ...
          it "1 item qualifies for a bulk discount" do
            ...
            expect(invoice_1.total_discounted_revenue(invoice_1, merchant_1)).to eq(28000)
          end
          ...
          it "applies the better of merchant's two discounts - 1 item meets 2 discounts' criteria" do
            ...
            expect(invoice_1.total_discounted_revenue(invoice_1, merchant_1)).to eq(25000)
          end
          ...
          it "each item meets criteria for separate discounts" do
            ...
            expect(invoice_1.total_discounted_revenue(invoice_1, merchant_1)).to eq(33000)
          end
          ...
          it "each item meets criteria for the same discount" do
            ...
            expect(invoice_1.total_discounted_revenue(invoice_1, merchant_1)).to eq(36000)
          end
          ...
          it "multiple merchants' items on an invoice - no qualifying discount" do
            ...
            expect(invoice_1.total_discounted_revenue(invoice_1, merchant_1)).to eq(10000)
            expect(invoice_1.total_discounted_revenue(invoice_1, merchant_2)).to eq(10000)
          end
          ...
          it "multiple merchants' items on an invoice - 1 qualifies for discount" do
            ...
            expect(invoice_1.total_discounted_revenue(invoice_1, merchant_1)).to eq(15000)
            expect(invoice_1.total_discounted_revenue(invoice_1, merchant_2)).to eq(12000)
          end
          ...
          it "multiple merchants' items on an invoice - both qualify for discount" do
            ...
            expect(invoice_1.total_discounted_revenue(invoice_1, merchant_1)).to eq(18000)
            expect(invoice_1.total_discounted_revenue(invoice_1, merchant_2)).to eq(16000)
          end
        end
      end
    end
